...
package  {
	...
	public class MapLevelSix extends MapBase {
		//Media content declarations
		[Embed(source="../assets/MapCSV_LevelSix_MainGame.txt", mimeType="application/octet-stream")] public var CSV_MainGame:Class;
		[Embed(source="../assets/game_tilesheetA32wide.png")] public var Img_MainGame:Class;

		
		public function MapLevelSix() {
			treesAllowed = 5;
			platformsAllowed = 5;
			explosionsAllowed = 5;
		...
		override public function addSpritesToLayerMainGame(onAddCallback:Function = null):void {
			...
			obj = new Pickup(695, 474);;
			obj.x+=obj.offset.x;
			obj.y+=obj.offset.y;
			FlxG.state.add(obj);
			if(onAddCallback != null)
				onAddCallback(obj);
			obj = new Exit(1137, 321);;
			obj.x+=obj.offset.x;
			obj.y+=obj.offset.y;
			FlxG.state.add(obj);
			if(onAddCallback != null)
				onAddCallback(obj);
			obj = new Player(218, 221);;
			obj.x+=obj.offset.x;
			obj.y+=obj.offset.y;
			FlxG.state.add(obj);
			if(onAddCallback != null)
